...
public class TestLandingPage {
	...
	//private static String serverBaseURL= System.getProperty("http://192.168.33.17:8080");

	private static String serverBaseURL= System.getProperty("serverBaseURL");

	private static String webpageURI= "/welcome/welcome";
	...
	public static void testContent() throws InterruptedException {
		...
		Thread.sleep(1000);
		String expectedString= "Welcome Stranger!";
